...
export const Tutorial = () => {
    return (
        <div style={{ overflowX: 'hidden' }}>
            ...
            {/* Tarjeta 6 - Bienvenida navegación */}
                ...
                <motion.div
                    ...
                    <div className="card-body p-4">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.4 }}>
                            <img src="/public/iconos/nav-libro.png"
                                style={{ width: '52px', height: '52px', borderRadius: '50%', flexShrink: 0 }} />
                            <span style={{ fontSize: '0.88rem', color: '#8c030e', lineHeight: '1.5' }}>
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.4, delay: 0.1 }}>
                            <img src="/public/iconos/nav-postit.png"
                                style={{ width: '52px', height: '52px', borderRadius: '50%', flexShrink: 0 }} />
                            <span style={{ fontSize: '0.88rem', color: '#000000', lineHeight: '1.5' }}>
                                Tus <strong>Post it</strong>, capturados en tus momentos favoritos
                            </span>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.4, delay: 0.2 }}>
                            <img src="/public/iconos/nav-decisiones.png"
                                style={{ width: '52px', height: '52px', borderRadius: '50%', flexShrink: 0 }} />
                            <span style={{ fontSize: '0.88rem', color: '#000000', lineHeight: '1.5' }}>
                                Tus <strong>Decisiones</strong>, tomadas a lo largo de la animación
                            </span>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.4, delay: 0.3 }}>
                            <img src="/public/iconos/nav-guardados.png"
                                style={{ width: '52px', height: '52px', borderRadius: '50%', flexShrink: 0 }} />
                            <span style={{ fontSize: '0.88rem', color: '#000000', lineHeight: '1.5' }}>
                                Tus <strong>Guardados</strong>, los que capturan tus escenas favoritas
                            </span>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            <img src="/public/iconos/nav-archivo.png"
                                style={{ width: '52px', height: '52px', borderRadius: '50%', flexShrink: 0 }} />
                            <span style={{ fontSize: '0.88rem', color: '#000000', lineHeight: '1.5' }}>
                                Tu <strong>Archivo creativo</strong>, tu mosaico emocional hecho en leersé.
                            </span>
                        </motion.div>
